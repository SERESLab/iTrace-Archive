 ...
 */
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txSetGazeAwareBehavior(
    TX_HANDLE hInteractor,
 ...
 */
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txSetActivatableBehavior(
    TX_HANDLE hInteractor,
 ...
 */
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txSetPannableBehavior(
    TX_HANDLE hInteractor,
 ...
 */
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txSetGazePointDataBehavior(
    TX_HANDLE hInteractor,
 ...
 */
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txSetFixationDataBehavior(
    TX_HANDLE hInteractor,
 ...
 */ 
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txCreateInteractorMask(
    TX_HANDLE hInteractor,
    TX_HANDLE* phMask,
 ...
 */
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txRemoveInteractorMask(
    TX_HANDLE hInteractor
    );
TX_C_END
 ...
 */
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txGetInteractorMask(
    TX_CONSTHANDLE hInteractor,
    TX_HANDLE* phMask
    );
TX_C_END
 ...
 */ 
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txGetInteractionMaskData(
 ...
 */ 
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txSetInteractorMaskBounds(
    TX_HANDLE hInteractor,
 ...
 */ 
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txClearInteractorMaskBounds(
    TX_HANDLE hInteractor
    );
TX_C_END
 ...
 */ 
TX_C_BEGIN
TX_API TX_RESULT TX_CALLCONVENTION txGetInteractorMaskBounds(
    TX_CONSTHANDLE hInteractor,
    TX_RECT* pBounds
    );
TX_C_END
