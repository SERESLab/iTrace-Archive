...
public class XMLBasicFixationFilter extends BasicFixationFilter {
	...
	public RawGaze getRawGaze(XMLStreamReader reader) {
		...
		int trackerTime = Integer.parseInt(reader.getAttributeValue(9));
		int systemTime = Integer.parseInt(reader.getAttributeValue(10));
		int nanoTime = Integer.parseInt(reader.getAttributeValue(11));
