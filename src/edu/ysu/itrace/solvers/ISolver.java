...
public interface ISolver {
 ...
 // defined in another, more specific, interface.
    /**
     * Any initialization work with side effects, such as
     * opening files. This method should very probably be
     * called before calling process or dispose.
     */
    public void init();
    ...
    /**
     * Frees any resources. It is very likely a bad idea to
     * process new data after calling dispose. Not sure if we need
     * this, either.
     */
    public void dispose();
}
